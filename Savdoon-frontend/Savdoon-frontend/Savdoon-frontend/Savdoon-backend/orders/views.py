    ...
    def post(self, request):
        ...
        try:
            ...
            order = Order.objects.create(
                store=store, customer_name=data['customer_name'], customer_phone=data['customer_phone'],
                delivery_type=data['delivery_type'], subtotal=subtotal, delivery_fee=15000, total=subtotal + 15000
            )
