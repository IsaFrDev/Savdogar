                ...
                {step === 1 && (
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <h2 className="text-3xl font-black text-white uppercase tracking-tight font-heading">Create Your Bot</h2>
                      <p className="text-lg font-medium text-slate-400 leading-relaxed">
                        Start by talking to <a href="https://t.me/BotFather" target="_blank" className="text-[var(--brand-primary)] font-black hover:brightness-125 transition-all decoration-2 underline-offset-4 underline">@BotFather</a> on Telegram to generate your unique API Token.
                      </p>
                    </div>
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 w-full">
                      <Button variant="outline" onClick={() => setStep(1)} className="flex-1 rounded-3xl h-18 font-black uppercase tracking-widest text-[10px] border-white/10 text-white hover:bg-white/5">Back</Button>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 pt-6">
                        ...
                        <Button
                          ...
                          className="flex-1 rounded-[1.75rem] h-20 px-10 font-black uppercase tracking-[0.2em] text-[11px] bg-white text-slate-900 shadow-2xl hover:scale-[1.02] active:scale-95 transition-all"
                        >
                ...
                {step === 4 && (
                  ...
                  >
                    ...
                    <div className="text-center space-y-3">
                      <h2 className="text-4xl font-black text-white uppercase tracking-tight font-heading">Connection Established</h2>
