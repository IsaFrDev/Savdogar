...
export const storeApi = {
    ...
    approveStore: (id: number) => api.post(`/stores/${id}/approve/`, {}),
    rejectStore: (id: number, reason?: string, reason_uz?: string, reason_ru?: string) => 
        api.post(`/stores/${id}/reject/`, { reason, reason_uz, reason_ru }),
