                  ...
                  {showUserMenu && (
                    ...
                    >
                      ...
                      <div className="px-6 py-4 border-t border-slate-50 mt-2">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Yaratuvchi <span className="text-indigo-500">Savdoon.uz</span></p>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://savdoon.uz" className="text-[10px] font-black text-indigo-500 uppercase tracking-widest hover:underline">Savdoon.uz</a>
            </div>
          </div>
        </div>
      </footer>
