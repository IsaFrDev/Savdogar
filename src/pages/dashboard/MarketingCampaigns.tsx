        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          >
            ...
            <p className="text-sm text-indigo-800/80 leading-relaxed font-bold uppercase tracking-tight opacity-70">
              Marketing orqali siz mijozlar bazasini kengaytirishingiz, sotuvlarni oshirishingiz va o'z brendingizni taniqli qilishingiz mumkin. Savdoon platformasi sizga eng samarali marketing vositalarini taqdim etadi.
            </p>
          </motion.div>
