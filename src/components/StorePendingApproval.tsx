            ...
            <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 overflow-hidden relative">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-bold mb-8">
                        ...
                        {t('storeRejectedTitle') || "Do'kon Rad Etildi"}
                    </div>

                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 text-left">
                        <h3 className="text-white font-bold mb-3">Rad etish sababi:</h3>
        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 overflow-hidden relative">
            ...
            >
                ...
                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-500 text-sm font-bold mb-8">
                    ...
                    {t('pendingApprovalTitle') || "Tasdiqlanish Kutmoqda"}
                </div>

                <p className="text-slate-400 text-lg font-medium leading-relaxed mb-10">
                    {t('pendingApprovalMsg') || "Do'koningiz admin tomonidan tasdiqlanishini kuting. Bu jarayon bir necha soat davom etishi mumkin."}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                        ...
                        <p className="text-xs text-slate-500 uppercase tracking-wider">Kutilayotgan vaqt</p>
                    </div>

                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                        <AlertCircle className="w-8 h-8 text-blue-500 mx-auto mb-3" />
                        <p className="text-2xl font-bold text-white mb-1">24 soat</p>
                        <p className="text-xs text-slate-500 uppercase tracking-wider">Taxminiy vaqt</p>
                    </div>

                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                        <CheckCircle className="w-8 h-8 text-green-500 mx-auto mb-3" />
                        <p className="text-2xl font-bold text-white mb-1">Tez orada</p>
                        <p className="text-xs text-slate-500 uppercase tracking-wider">Tasdiqlanadi</p>
                    </div>
                </div>

                <div className="p-6 rounded-2xl bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 mb-8">
                    <h3 className="text-white font-bold mb-3">Keyingi qadamlar:</h3>
                    <ul className="text-left text-slate-300 space-y-2">
                        <li className="flex items-start gap-2">
                            <span className="text-amber-500 mt-1">✓</span>
                            <span>Admin do'koningizni ko'rib chiqadi</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <span className="text-amber-500 mt-1">✓</span>
                            <span>Tasdiqlangach bildirishnoma olasiz</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <span className="text-amber-500 mt-1">✓</span>
                            <span>Do'koningiz ishga tushadi</span>
                        </li>
                    </ul>
                </div>
