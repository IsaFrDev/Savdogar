...
export function TelegramCardCreator() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            ctx.fillText('@Bozorchi AIBot', width / 2, 1120);

            ctx.fillStyle = '#708499';
            ctx.font = '500 24px Inter, sans-serif';
            ctx.fillText('Powered by Bozorchi AI.uz', width / 2, 1160);
    ...
    const shopUrl = `https://t.me/Bozorchi AIBot?start=${activeStoreId}`;
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                >
                    ...
                    <h2 className="text-2xl font-black text-white uppercase tracking-tight mb-1 z-10">
                        {storeData?.name || 'Bozorchi AI Store'}
                    </h2>
