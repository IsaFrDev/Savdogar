...
class DebtTransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'debt', 'amount', 'transaction_type', 'transaction_date',
...
class CustomerDebtSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomerDebt
        fields = [
            'id', 'store', 'customer_name', 'customer_phone', 'customer',
            'total_debt', 'limit', 'notes', 'transactions',
            'last_transaction_at', 'created_at'
        ]
        read_only_fields = ['total_debt', 'last_transaction_at', 'created_at']
