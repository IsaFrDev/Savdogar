...
@extend_schema(
    ...
    description="Generates a 30-day sales forecast using simple linear regression.",
    responses={200: inline_serializer("ForecastResponse", fields={
        "trend": serializers.CharField(),
        "change_pct": serializers.FloatField(),
        "avg_daily": serializers.FloatField(),
        "total_period": serializers.FloatField(),
