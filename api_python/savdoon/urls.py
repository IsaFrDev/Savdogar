...
urlpatterns = [
    ...
    path('api/integrations/', include('integrations.urls')),  # Payment & Marketplace Integrations
    path('api/analytics/forecast/', analytics_views.forecast_view, name='forecast'),
    path('api/analytics/', include('analytics.urls')),  # Advanced Analytics Dashboard
